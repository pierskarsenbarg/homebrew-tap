class PulumiPackageDocs < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/pierskarsenbarg/pulumi-package-docs/releases/download/v0.7.0/pulumi-package-docs-darwin-arm64"
      sha256 "9c3483565732705dbaf242a930e7741db585f98f44d8b89315960b1c691390f8"
    end
    on_intel do
      url "https://github.com/pierskarsenbarg/pulumi-package-docs/releases/download/v0.7.0/pulumi-package-docs-darwin-x64"
  ...
  on_linux do
    on_arm do
      url "https://github.com/pierskarsenbarg/pulumi-package-docs/releases/download/v0.7.0/pulumi-package-docs-linux-arm64"
      sha256 "38e54746077af8e667b8e73cd01365eb7b34c4bc1b69c2f7c6a1e6b7b71e6f0d"
    end
    on_intel do
      url "https://github.com/pierskarsenbarg/pulumi-package-docs/releases/download/v0.7.0/pulumi-package-docs-linux-x64"
